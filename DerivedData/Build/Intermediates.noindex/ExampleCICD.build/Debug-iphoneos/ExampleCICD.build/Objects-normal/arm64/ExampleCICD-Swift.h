...
#ifndef EXAMPLECICD_SWIFT_H
#define EXAMPLECICD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ExampleCICD",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11ExampleCICD11AppDelegate")
...
SWIFT_CLASS("_TtC11ExampleCICD13SceneDelegate")
...
SWIFT_CLASS("_TtC11ExampleCICD14ViewController")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified resultadoDeTexto;
- (void)viewDidLoad;
